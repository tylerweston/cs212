...
def evaluate_expression_tree(tree_in, environment):
    def exp(tree):
        if len(tree) == 4:
            ...
            raise Exception("exp evaluation failed. ")
            return False
    ...
    def term(tree):
        if len(tree) == 4:
            ...
            raise Exception("term evaluation failed. ")
            return False
    ...
    def word(tree):
        if len(tree) == 3:
            ...
            raise Exception("word evaluation failed. ")
            return False
    ...
    def factor(tree):
        if len(tree) == 2:
            ...
            try:
                ...
                raise Exception("variable %s is not defined.", tree[1][1])
            return value
        elif len(tree) == 4:
            return exp(tree[2])
        else:
            raise Exception("factor evaluation failed. ")
            return False
